...
const NavigationContents2 = async () => {
  ...
  return (
    <div className="flex gap-9">
      ...
      <div className="relative group">
        ...
        <div className="absolute py-6 px-5 rounded-lg hidden w-[250px] bg-white  shadow-lg z-10 group-hover:block">
...
export default NavigationContents2;
