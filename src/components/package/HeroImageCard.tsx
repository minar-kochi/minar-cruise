    ...
    <div className={cn("", className)}>
      <div className="pb-3 md:pb-5 ">
        <div className="">
          ...
          <p className="hidden md:block text-primary ">(4:30 PM - 6:30 PM)</p>
        </div>
      </div>
      ...
      <div className="flex justify-between p-4 relative">
        <div className="basis-[40%]">
          <div className="flex flex-col justify-between items-end  h-full gap-4">
            <div className=" w-full">
              <Image
                alt=""
                src={"/assets/package/BreakFastDish.webp"}
                width={1920}
                height={1080}
        ...
        <div className="basis-[40%]">
          <div className="flex flex-col   h-full gap-4">
            ...
            <Image
              alt=""
              src={"/assets/package/Breakfast1.webp"}
              width={1920}
              height={1080}
        ...
        <div className="absolute top-[25%] right-[30%] ">
          <Image
            alt=""
            src={"/assets/package/SunsetView.webp"}
            width={1920}
            height={1080}
