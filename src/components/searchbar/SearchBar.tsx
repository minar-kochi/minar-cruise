...
const SearchBar = () => {
  ...
  return (
    <div className="flex items-center justify-center w-full ">
      <div className="w-full  max-w-md mx-auto  rounded-l-full rounded-r-full bg-background pr-3 pl-6 ">
        <div className="flex w-full  md:gap-0 justify-between items-center  md:grid md:grid-cols-[35%_35%_30%] md:place-content-center md:place-items-center">
          ...
          <SearchMobileBar />
          <ChooseDates/>
          <div className="h-full  w-full  py-1 flex items-center flex-nowrap flex-grow  justify-end ">
            <Link
