...
export type CalendarProps = React.ComponentProps<typeof DayPicker> &  {sizeMode?: "lg" | "sm"};

const CalendarVarients = ({classNames,props}:{classNames?: Partial<StyledElement<string>>, props:CalendarProps})=> ({
  lg: {
