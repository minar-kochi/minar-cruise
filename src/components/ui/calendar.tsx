...
const CalendarVarients = ({
  ...
  lg: {
    ...
    day: cn(
      buttonVariants({ variant: "ghost" }),
      "w-full p-0  font-normal  aria-selected:opacity-100 group hover:text-primary-foreground hover:scale-110 hover:bg-blue-400",
    ),
    day_range_end: "day-range-end",
    day_selected:
      "bg-blue-400 relative z-10 focus:font-bold text-secondary-foreground hover:bg-blue-400 hover:text-primary-foreground focus:bg-blue-400 focus:text-primary-foreground  transition-all duration-300 focus:text-lg scale-110",
    day_today: "",
    day_outside:
      "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30",
    day_disabled: "",
