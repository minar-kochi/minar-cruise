...
const buttonVariants = cva(
  "inline-flex items-center  justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none",
  {
    variants: {
      variant: {
        confirm: " text-green-600 border border-green-600 hover:bg-black",
        greenFlag: " bg-green-700",
        destructiveOutline:
          "text-destructive border-2 border-destructive hover:text-black hover:bg-destructive",
        ...
        dangerLink: "text-red-600 underline-offset-4 hover:underline bg-transparent",
