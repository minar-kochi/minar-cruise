...
export const operation = {
  ...
  description:
    "We are currently operating mainly in Kochi, the enchanting charm of the Arabian Sea and the hotspot of tourism in Kerala. Kochi offers a cocktail of old-world charm with an electrifying beauty of the modern-day world. For centuries, Kochi had been the main port city, not only of Kerala but also of the Indian Peninsula. The traders and travelers from across the globe were welcomed with open arms and minds. This greatly helped in its growth into a cosmopolitan city. Rated as one of the ’50 Greatest Places to Visit in a Lifetime by National Geographic Traveller Magazine, Kochi is truly a meeting point of history and culture.",
};
